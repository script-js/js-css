...
((window, factory) => {
  ...
  class ChromeTabs {
    ...
    createNewTabEl() {
      ...
      div.innerHTML = `<div ifd="${tabC++}"class="chrome-tab" onclick="opencity('${tabC}')" ondblclick="titleChanger('${tabC}')">
...
function titleChanger(id) {
  document.getElementsByClassName(id)[0].innerText = prompt("Tab Title:")
}
